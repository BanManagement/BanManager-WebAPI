...
var multiline = require('multiline')
  , sql =
[ multiline(function () {/*
CREATE TABLE `bm_ip_ban_all` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ip` int(10) unsigned NOT NULL,
  `reason` varchar(255) NOT NULL,
  `actorUuid` binary(16) NOT NULL,
  `actorName` varchar(16) NOT NULL,
  `created` int(10) NOT NULL,
  `expires` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_ip_ban_all_actorUuid_idx` (`actorUuid`),
  KEY `bm_ip_ban_all_expires_idx` (`expires`),
  KEY `bm_ip_ban_all_created_idx` (`created`)
...
CREATE TABLE `bm_ip_range_bans` (
  ...
  KEY `bm_ip_range_bans_fromIp_idx` (`fromIp`),
  KEY `bm_ip_range_bans_created_idx` (`created`),
  KEY `bm_ip_range_bans_updated_idx` (`updated`),
  KEY `bm_ip_range_bans_toIp_idx` (`toIp`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
CREATE TABLE `bm_ip_unban_all` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ip` int(10) unsigned NOT NULL,
  `actorUuid` binary(16) NOT NULL,
  `actorName` varchar(16) NOT NULL,
  `created` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_ip_unban_all_actorUuid_idx` (`actorUuid`),
  KEY `bm_ip_unban_all_created_idx` (`created`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
CREATE TABLE `bm_player_ban_all` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `expires` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_player_ban_all_created_idx` (`created`),
...
*/})
, multiline(function () {/*
CREATE TABLE `bm_player_mute_all` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uuid` binary(16) NOT NULL,
  `name` varchar(16) NOT NULL,
  `reason` varchar(255) NOT NULL,
  ...
  `soft` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_player_mute_all_actorUuid_idx` (`actorUuid`),
  KEY `bm_player_mute_all_soft_idx` (`soft`),
  KEY `bm_player_mute_all_uuid_idx` (`uuid`),
  KEY `bm_player_mute_all_expires_idx` (`expires`),
  KEY `bm_player_mute_all_created_idx` (`created`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
...
CREATE TABLE `bm_player_note_all` (
  ...
  `created` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_player_note_all_created_idx` (`created`),
  KEY `bm_player_note_all_uuid_idx` (`uuid`),
  KEY `bm_player_note_all_actorUuid_idx` (`actorUuid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
...
CREATE TABLE `bm_player_unban_all` (
  ...
  `created` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_player_unban_all_actorUuid_idx` (`actorUuid`),
  KEY `bm_player_unban_all_uuid_idx` (`uuid`),
  KEY `bm_player_unban_all_created_idx` (`created`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
CREATE TABLE `bm_player_unmute_all` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uuid` binary(16) NOT NULL,
  `name` varchar(16) NOT NULL,
  `actorUuid` binary(16) NOT NULL,
  ...
  `created` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `bm_player_unmute_all_uuid_idx` (`uuid`),
  KEY `bm_player_unmute_all_actorUuid_idx` (`actorUuid`),
  KEY `bm_player_unmute_all_created_idx` (`created`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
*/})
, multiline(function () {/*
...
exports.up = function (knex, Promise) {
  // @TODO convert this into knex
  return Promise.all(sql.map(function (sql) {
    return knex.raw(sql)
  }))
}

exports.down = function (knex) {
  knex.schema.dropTable('bm_ip_ban_all')
  knex.schema.dropTable('bm_ip_ban_records')
  knex.schema.dropTable('bm_ip_bans')
  knex.schema.dropTable('bm_ip_mute_records')
  knex.schema.dropTable('bm_ip_mutes')
  knex.schema.dropTable('bm_ip_range_ban_records')
  knex.schema.dropTable('bm_ip_range_bans')
  knex.schema.dropTable('bm_ip_unban_all')
  knex.schema.dropTable('bm_player_ban_all')
  knex.schema.dropTable('bm_player_ban_records')
  knex.schema.dropTable('bm_player_bans')
  knex.schema.dropTable('bm_player_history')
  knex.schema.dropTable('bm_player_kicks')
  knex.schema.dropTable('bm_player_mute_all')
  knex.schema.dropTable('bm_player_mute_records')
  knex.schema.dropTable('bm_player_mutes')
  knex.schema.dropTable('bm_player_note_all')
  knex.schema.dropTable('bm_player_notes')
  knex.schema.dropTable('bm_player_report_commands')
  knex.schema.dropTable('bm_player_report_comments')
  knex.schema.dropTable('bm_player_report_locations')
  knex.schema.dropTable('bm_player_report_states')
  knex.schema.dropTable('bm_player_reports')
  knex.schema.dropTable('bm_player_unban_all')
  knex.schema.dropTable('bm_player_unmute_all')
  knex.schema.dropTable('bm_player_warnings')
  knex.schema.dropTable('bm_players')
  knex.schema.dropTable('bm_report_logs')
  knex.schema.dropTable('bm_server_logs')
}
